...
[`@aws-sdk/client-elasticsearch-service`](https://www.npmjs.com/package/@aws-sdk/client-elasticsearch-service/v/3.1115.0).
...
- @aws-sdk/client-elasticsearch-service v3.1115.0 - [https://cloud-sdk-builds.github.io/?sdk=client-elasticsearch-service&version=3.1115.0](https://cloud-sdk-builds.github.io/?sdk=client-elasticsearch-service&version=3.1115.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-elasticsearch-service@3.1115.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cxEbchlX1DDeWGggy+Dn+MXZA0w+tGwdU1H6aGjsEbxWeDTBC3eRGn9wzagiC7gc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-elasticsearch-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-elasticsearch-service@3.1115.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-elasticsearch-service@3.1115.0/index.min.mjs": "sha384-cxEbchlX1DDeWGggy+Dn+MXZA0w+tGwdU1H6aGjsEbxWeDTBC3eRGn9wzagiC7gc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-elasticsearch-service/blob/refs/tags/3.1115.0/LICENSE
```
