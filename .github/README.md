...
[`@aws-sdk/client-elasticsearch-service`](https://www.npmjs.com/package/@aws-sdk/client-elasticsearch-service/v/3.1100.0).
...
- @aws-sdk/client-elasticsearch-service v3.1100.0 - [https://cloud-sdk-builds.github.io/?sdk=client-elasticsearch-service&version=3.1100.0](https://cloud-sdk-builds.github.io/?sdk=client-elasticsearch-service&version=3.1100.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-elasticsearch-service@3.1100.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Y4y2ptrbEuqpKcyxvcASQxx8pPZOLzxSymABfw7LBoB4UO2SYQFmu6i4qav6B5O3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-elasticsearch-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-elasticsearch-service@3.1100.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-elasticsearch-service@3.1100.0/index.min.mjs": "sha384-Y4y2ptrbEuqpKcyxvcASQxx8pPZOLzxSymABfw7LBoB4UO2SYQFmu6i4qav6B5O3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-elasticsearch-service/blob/refs/tags/3.1100.0/LICENSE
```
